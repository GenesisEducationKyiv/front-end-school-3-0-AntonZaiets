...
describe('TrackForm Integration', () => {
  test('should handle form submission with valid data', async () => {
    ...
    const genreInput = screen.getByTestId('genre-selector');
    ...
    // Verify the selected genres are displayed
    ...
    // Додати перевірку, що немає помилок валідації
