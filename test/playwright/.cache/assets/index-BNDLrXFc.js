const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/TrackFormStory-Da1Id3mY.js","assets/TrackForm-aNiWFFDF.js","assets/index-BNcAPA1_.js","assets/index-B35keSyw.js"])))=>i.map(i=>d[i]);
...
function requireReactDom_production_min () {
	...
	*/
	'use strict';var aa=requireReact(),ca=requireScheduler();function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return "Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b);}
...
const D__cursos_tests_front_end_school_3_0_AntonZaiets_src_components_TrackForm___stories___TrackFormStory_TrackFormStory = () => __vitePreload(() => import('./TrackFormStory-Da1Id3mY.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0).then((mod) => mod.TrackFormStory);
const D__cursos_tests_front_end_school_3_0_AntonZaiets_src_components_TrackForm_TrackForm = () => __vitePreload(() => import('./TrackForm-aNiWFFDF.js').then(n => n.a),true              ?__vite__mapDeps([1,2]):void 0).then((mod) => mod.default);
const D__cursos_tests_front_end_school_3_0_AntonZaiets_src_components_TrackForm___tests____tanstack_react_query_QueryClientProvider = () => __vitePreload(() => import('./index-B35keSyw.js'),true              ?__vite__mapDeps([3,2]):void 0).then((mod) => mod.QueryClientProvider);
__pwRegistry.initialize({ D__cursos_tests_front_end_school_3_0_AntonZaiets_src_components_TrackForm___stories___TrackFormStory_TrackFormStory,
  D__cursos_tests_front_end_school_3_0_AntonZaiets_src_components_TrackForm_TrackForm,
  D__cursos_tests_front_end_school_3_0_AntonZaiets_src_components_TrackForm___tests____tanstack_react_query_QueryClientProvider });

export { React as R, reactExports as a, React$1 as b, getAugmentedNamespace as c, requireReactDom as d, getDefaultExportFromCjs as g, requireReact as r };
//# sourceMappingURL=index-BNDLrXFc.js.map
